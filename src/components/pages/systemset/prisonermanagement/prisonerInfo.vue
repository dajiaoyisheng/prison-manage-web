            ...
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item label="刑期（月）" prop="criPrisonterm">
                        <el-input-number style="width: 220px; margin-right:10px;" v-model="form.criPrisonterm" :precision="0" :step="1" :min="1"></el-input-number>
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
...
export default {
    data() {
        return {
            ...
            rules: {
                criCode: [
                    { required: true, message: '请输入罪犯编号', trigger: 'change' }
                ],
                criIdcard: [
                ...
                criFrontCode: [
                    { required: true, message: '请输入身前视觉码编号', trigger: 'blur' }
                ],
                criBackCode: [
                    { required: true, message: '请输入身后视觉码编号', trigger: 'blur' }
                ],
                criState: [
                    { required: true, message: '请选择当前状态', trigger: 'blur' }
                ]
