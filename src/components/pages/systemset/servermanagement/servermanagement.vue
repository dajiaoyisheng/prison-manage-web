            ...
            <el-card class="sm-main-item">
              ...
              <div class="sm-main-item-content">
                ...
                <el-row class="item">
                  ...
                  <el-col :span="14">
                    <el-input placeholder="请输入服务地址" v-model="engineItem.address" clearable></el-input>
                  </el-col>
                </el-row>
              </div>
            </el-card>
            ...
            <el-card class="sm-main-item">
              ...
              <div class="sm-main-item-content" v-for="(item, key) in specialItems" :key="key" v-bind:class="{'active' : key!=0}" @mouseenter="enter('username', key)" @mouseleave="leave">
                <el-row class="item">
                  <el-col :span="6"><span>服务地址：</span></el-col>
                  <el-col :span="14">
                    <el-input placeholder="请输入服务地址" v-model="item.address" clearable></el-input>
                  </el-col>
                </el-row>
                <el-row class="item">
                  <el-col :span="6"><span>用户名：</span></el-col>
                  <el-col :span="14">
                    <el-input placeholder="请输入用户名" v-model="item.username" clearable></el-input>
                  </el-col>
                ...
                <el-row class="item">
                  <el-col :span="6"><span>密码：</span></el-col>
                  <el-col :span="14">
                    <el-input placeholder="请输入密码" v-model="item.password" clearable></el-input>
                  </el-col>
                </el-row>
              </div>
            </el-card>
  ...
  export default {
    ...
    methods: {
      ...
      getServerInfo: function () {
        this.$get(this.urlconfig.ssmGetServerInfo).then((res) => {
          if (res.status === 0) {
            this.serverItem = res.data.serverItem;
            this.engineItem = res.data.engineItem;
            this.specialItems = res.data.specialItems;
          }
        }).catch((error) => {
          console.log(error);
        }).then(() => {
