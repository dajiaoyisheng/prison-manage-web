...
function install(Vue, options = {}) {
    ...
    const DEFAULT_OPTION = {
        locale: 'zh', // en
        color: '#757575',
        restDayColor: '#59C4EE', //休息日字体颜色
        festivalColor: '#FF7761', //节假日字体颜色
    ...
    let Calendar = {
        ...
        setCurMonth(curMonth) {
            this.$vm.CALENDAR_EVENTS_DATA.params.curMonth = curMonth;
        },
        setCurYear(curYear) {
            this.$vm.CALENDAR_EVENTS_DATA.params.curYear = curYear;
        },
        nextMonth() {
