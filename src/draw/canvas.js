...
var RotationToMouse = function(mx, my, ox, oy) {
    var dx = mx - ox;
    var dy = my - oy;
...
//捕获坐标
var CaptureMouse = function(canvas) {
 ...
 * @return {Boolean}
 */
var IsCollision = function(a, b, c, d) {
...
//画网格线
var DrawGrid = function(ctx, color, stepx, stepy) {
    ctx.save();
    ctx.lineWidth = 0.5;
...
export { Rotates, Tween, QuadraticPos, BezierPos, Curve, Shape, DrawGrid, IsCollision, WindowToCanvas, CaptureMouse, RotationToMouse, Color, RandomHsl, RandomColor, Random }